...
public final class Murmur3 {
    ...
    public static Hasher arrayHasher(int i) {
        return new Murmur3ArrayHasher(i);
    }

    public static Hasher arrayHasher() {
        return new Murmur3ArrayHasher(0);
    }

    public static Hasher bufferHasher(int i) {
        return new Murmur3BufferHasher(i);
    }

    public static Hasher bufferHasher() {
        return new Murmur3BufferHasher(0);
    }
    ...
    static long getLongLittleEndian(byte[] buf, int offset) {
    ...
    static int churn(int k1, int h1) {
        k1 *= c1;
    ...
    static byte[] finish(int h1, long byteCount) {
        // finalization
        h1 ^= byteCount;
    ...
    public static byte[] murmurhash3_x86_32(byte[] data, int offset, int len, int seed) {
    ...
    @SuppressWarnings("fallthrough")
    public static void murmurhash3_x64_128(byte[] key, int offset, int len, int seed, Murmur3.LongPair out) {
